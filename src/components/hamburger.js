...
class Hamburger extends React.Component {
    ...
    // See https://github.com/negomi/react-burger-menu#custom-icon
        ...
        return (
            <div className="flex-initial h-16">
                <div className="w-screen h-full">
                    ...
                    >
                        ...
                        >
                            <StaticImage
                                ...
                                loading="eager"
                                placeholder="tracedSVG"
                                className="block p-0 m-0 mr-4"
                            />
                        </Link>
                        <Link
                            to="/"
                            className="text-gray-900 hover:text-purple-700 font-light"
                    ...
                    <div className="absolute top-4 right-4 w-10 h-auto">
                        <Link to="/">
                            <StaticImage
                                className="block p-0 m-0"
                                imgClassName="max-h-24 w-auto"
                                placeholder="tracedSVG"
                                loading="eager"
                                src="../images/reid-logo.png"
                                alt="Header logo"
